...
const FetchData = () => {
  ...
  return (
    <div className="container m-auto my-14">
      <h3 className="font-serif text-8xl text-cyandark ">
        Know your <br /> contry....
      </h3>
      <input
        type="text"
      ...
      <div>
        {query.toLowerCase().startsWith("isr") ? (
          <h3 className="text-2xl font-semibold text-cyandark">
            no country with this name only palestine
          </h3>
        ) : (
          <table className=" border-2 border-cyandark text-white divide-x divide-y divide-cyandark table-fixed  w-[650px] md:w-[800px]">
            <thead className="text-lg text-cyandark">
              ...
              <th className="p-2 font-bold border border-cyandark">
                people count
              </th>
